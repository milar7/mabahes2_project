                ...
                <div className="position-relative overflow-hidden  p-md-5 m-md-3 text-center bg-light">
                    <div className="col-md-5 p-lg-5 mx-auto my-5">
                        ...
                        <p className="lead fw-normal">
                            اینجا جایی هست که می‌تونی رزومه‌ي کار‌هایی که تا حالا انجام دادی رو در
                            معرض دید بقیه قرار بدی و برای شروع کار جدید اعلام آماد‌گی و خودنمایی
                            کنی! برای شروع فقط کافیه که ثبت‌نام کنی
                        </p>
                    </div>
